...
const ActivityChart: React.FC<ActivityChartProps> = ({ data }) => {
    ...
    return (
        <div>
            <div className="w-full h-64 flex items-end justify-between space-x-1 relative mb-1">
                {data.map((day, i) => (
                    <div key={i} className="flex-1 flex flex-col items-center group relative">
                        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-8 bg-gray-900 text-white text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                        ...
                        <div className="flex flex-col items-center space-y-1 w-full">
                            <div
                                className="w-full max-w-[40px] bg-blue-100 dark:bg-blue-900/30 rounded-t-md transition-all duration-300 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/40"
                                style={{ height: `${(day.emails / maxEmails) * 100}%` }}
                            >
                                <div
            ...
            <div className="flex justify-center mt-6 space-x-6">
                ...
                <div className="flex items-center">
                    <div className="w-3 h-3 bg-blue-600 dark:bg-blue-500 rounded mr-2"></div>
